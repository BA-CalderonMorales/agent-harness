...
var themes = map[string]Palette{
	"default": {
		...
		Surface: c("#1E1E2E"), Border: c("#3A3A4A"), Muted: c("#878799"),
		Highlight: c("#2A2A3E"),
	},
	"midnight": {
		...
		Surface: c("#12141F"), Border: c("#2A2F45"), Muted: c("#76809A"),
		Highlight: c("#1C2033"),
	},
	"forest": {
		...
		Surface: c("#15221A"), Border: c("#2C4234"), Muted: c("#6F8F79"),
		Highlight: c("#1E3125"),
	},
	"solarized": {
	...
	"github-dark": {
		...
		Surface: c("#0D1117"), Border: c("#30363D"), Muted: c("#767E8A"),
		Highlight: c("#161B22"),
	},
	"cobalt": {
		Primary: c("#84D0FF"), Secondary: c("#3DDDE2"), Accent: c("#FFFA6A"),
		Success: c("#3DDDE2"), Error: c("#F14481"), Warning: c("#FF8A3D"),
		Info: c("#68A1F8"), Text: c("#DCF1FF"), TextDim: c("#6B8BA3"),
		Surface: c("#0F1B44"), Border: c("#1C3A6B"), Muted: c("#6588BE"),
		Highlight: c("#14295A"),
	},
	"paper": {
		Primary: c("#4A6FA5"), Secondary: c("#8A5A44"), Accent: c("#B08947"),
		Success: c("#5B8770"), Error: c("#A54444"), Warning: c("#B08947"),
		Info: c("#4A6FA5"), Text: c("#2B2B28"), TextDim: c("#716D62"),
		Surface: c("#F5F2EA"), Border: c("#D4CFC1"), Muted: c("#746C5B"),
		Highlight: c("#EAE6DA"),
	},
	"moss": {
		...
		Surface: c("#232822"), Border: c("#3C4438"), Muted: c("#86927F"),
		Highlight: c("#2E362C"),
	},
	"ember": {
		...
		Surface: c("#241C1A"), Border: c("#40332F"), Muted: c("#97837A"),
		Highlight: c("#322622"),
	},
	"ice": {
		...
		Surface: c("#1B2733"), Border: c("#31404F"), Muted: c("#7991A2"),
		Highlight: c("#243447"),
	},
}
